...
int main(int, char**)
{
	...
	addWeighted(img1, alpha, beta, beta, beta, img1_Mat_half, -1);
	...
	addWeighted(img1, alpha, beta, beta, beta, img1_Mat_double, -1);
	...
	cvtColor(img2, img2_Mat_gray,COLOR_BGR2GRAY,1);
	...
	cvtColor(img3, img3_Mat_gray, COLOR_BGR2GRAY, 1);

	imshow("problem3_lena_16_gray", img3_Mat_gray);
	imwrite("problem3_lena_16_gray.bmp", img3_Mat_gray);
